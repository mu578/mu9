...
mu0_scope_begin                                                                                                                                 \
	...
	for (                                                                                                                                        \
		...
		__mu9_parallel_accumulate00__v__ = __mu9_parallel_accumulate00__v__ + __mu9_parallel_accumulate00__p__[__mu9_parallel_accumulate00__i__]; \
	}                                                                                                                                            \
...
mu0_scope_begin                                                                                      \
	...
	{                                                                                                 \
		_Tp __mu9_parallel_accumulate01__w__ = mu0_const_cast(_Tp, { 0 });                             \
...
#	define mu9_parallel_accumulate02(_Tp, __first1, __last1, __first2, __init, __d_result)              \
mu0_scope_begin                                                                                        \
	_Tp                  __mu9_parallel_accumulate02__v__ = mu0_const_cast(_Tp, __init);                \
	_Tp *                __mu9_parallel_accumulate02__x__ = mu9_begin(_Tp, __first1);                   \
	_Tp *                __mu9_parallel_accumulate02__y__ = mu9_begin(_Tp, __first2);                   \
	const mu0_distance_t __mu9_parallel_accumulate02__n__ = mu9_const_distance(_Tp, __first1, __last1); \
	__mu0_pragma__(omp parallel for simd reduction(+:__mu9_parallel_accumulate02__v__))                 \
	for (                                                                                               \
		...
		__mu9_parallel_accumulate02__v__ = (__mu9_parallel_accumulate02__v__ + (                         \
			  __mu9_parallel_accumulate02__x__[__mu9_parallel_accumulate02__i__]                          \
			+ __mu9_parallel_accumulate02__y__[__mu9_parallel_accumulate02__i__]                          \
		));                                                                                              \
	}                                                                                                   \
	__d_result = __mu9_parallel_accumulate02__v__;                                                      \
mu0_scope_end

#	define mu9_parallel_accumulate03(_Tp, __first1, __last1, __first2, __init, __binary_op, __d_result) \
mu0_scope_begin                                                                                        \
	...
	__mu0_pragma__(omp parallel)                                                                        \
	{                                                                                                   \
		_Tp __mu9_parallel_accumulate03__w__ = mu0_const_cast(_Tp, { 0 });                               \
		__mu0_pragma__(omp for simd)                                                                     \
		for (                                                                                            \
			...
			__mu9_parallel_accumulate03__w__ = __binary_op(_Tp                                            \
				, __mu9_parallel_accumulate03__w__                                                         \
				, __binary_op(_Tp                                                                          \
		...
		__mu0_pragma__(omp critical)                                                                     \
		{                                                                                                \
			__mu9_parallel_accumulate03__v__ = __binary_op(_Tp                                            \
				, __mu9_parallel_accumulate03__v__                                                         \
				, __mu9_parallel_accumulate03__w__                                                         \
			);                                                                                            \
		}                                                                                                \
	}                                                                                                   \
...
#	define mu9_parallel_accumulate04(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result) \
mu0_scope_begin                                                                                                       \
	...
	__mu0_pragma__(omp parallel)                                                                                       \
	{                                                                                                                  \
		_Tp __mu9_parallel_accumulate04__w__ = mu0_const_cast(_Tp, { 0 });                                              \
		__mu0_pragma__(omp for simd)                                                                                    \
		for (                                                                                                           \
			...
			__mu9_parallel_accumulate04__w__ = __binary_op1(_Tp                                                          \
		...
		__mu0_pragma__(omp critical)                                                                                    \
		{                                                                                                               \
			__mu9_parallel_accumulate04__v__ = __binary_op1(_Tp                                                          \
...
#	define mu9_parallel_accumulate05(_Tp, __first1, __last1, __first2, __init, __trinary_op, __d_result) \
mu0_scope_begin                                                                                         \
	...
	__mu0_pragma__(omp parallel)                                                                         \
	{                                                                                                    \
		_Tp __mu9_parallel_accumulate05__w__ = mu0_const_cast(_Tp, { 0 });                                \
		__mu0_pragma__(omp for simd)                                                                      \
		for (                                                                                             \
			...
			__mu9_parallel_accumulate05__w__ = __trinary_op(_Tp                                            \
		...
		__mu0_pragma__(omp critical)                                                                      \
		{                                                                                                 \
			_Tp __mu9_parallel_accumulate05__z__ = mu0_const_cast(_Tp, { 0 });                             \
			__mu9_parallel_accumulate05__v__     = __trinary_op(_Tp                                        \
				, __mu9_parallel_accumulate05__v__                                                          \
				, __mu9_parallel_accumulate05__w__                                                          \
				, __mu9_parallel_accumulate05__z__                                                          \
			);                                                                                             \
		}                                                                                                 \
	}                                                                                                    \
...
//#!
#	define mu9_sequencial_accumulate3(_Tp, __first1, __last1, __first2, __init, __d_result) \
	mu9_accumulate3(_Tp, __first1, __last1, __first2, __init, __d_result)

//#!
//#! macro<_Tp, execution=parallel>(_Tp &* __first1, _Tp &* __last1, _Tp &* __first2, _Tp __init, _Tp<return> & __d_result) : void
//#!
#	if MU0_HAVE_PARALLELIZE
#	define mu9_parallel_accumulate3(_Tp, __first1, __last1, __first2, __init, __d_result) \
	mu9_parallel_accumulate02(_Tp, __first1, __last1, __first2, __init, __d_result)
#	else
#	define mu9_parallel_accumulate3(_Tp, __first1, __last1, __first2, __init, __d_result) \
	mu9_sequencial_accumulate3(_Tp, __first1, __last1, __first2, __init, __d_result)
#	endif

//#!
//#! macro<_Tp, execution=sequencial>(_Tp &* __first1, _Tp &* __last1, _Tp &* __first2, _Tp __init, __binary_op, _Tp<return> & __d_result) : void
//#!
#	define mu9_sequencial_accumulate4(_Tp, __first1, __last1, __first2, __init, __binary_op, __d_result) \
	mu9_accumulate4(_Tp, __first1, __last1, __first2, __init, __binary_op, __d_result)

//#!
//#! macro<_Tp, execution=parallel>(_Tp &* __first1, _Tp &* __last1, _Tp &* __first2, _Tp __init, __binary_op, _Tp<return> & __d_result) : void
//#!
#	if MU0_HAVE_PARALLELIZE
#	define mu9_parallel_accumulate4(_Tp, __first1, __last1, __first2, __init, __binary_op, __d_result) \
	mu9_parallel_accumulate03(_Tp, __first1, __last1, __first2, __init, __binary_op, __d_result)
#	else
#	define mu9_parallel_accumulate4(_Tp, __first1, __last1, __first2, __binary_op, __init, __d_result) \
	mu9_sequencial_accumulate4(_Tp, __first1, __last1, __first2, __init, __binary_op, __d_result)
#	endif
...
//#!
#	define mu9_sequencial_accumulate5(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result) \
	mu9_accumulate5(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result)
...
//#!
#	if MU0_HAVE_PARALLELIZE
#	define mu9_parallel_accumulate5(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result)  \
	mu9_parallel_accumulate04(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result) 
#	else
#	define mu9_parallel_accumulate5(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result)  \
	mu9_sequencial_accumulate5(_Tp, __first1, __last1, __first2, __init, __binary_op1, __binary_op2, __d_result) 
#	endif

//#!
//#! macro<_Tp, execution=sequencial>(_Tp &* __first1, _Tp &* __last1, _Tp &* __first2, _Tp __init, __trinary_op, _Tp<return> & __d_result) : void
//#!
#	define mu9_sequencial_accumulate6(_Tp, __first1, __last1, __first2, __init, __trinary_op, __d_result) \
	mu9_accumulate6(_Tp, __first1, __last1, __first2, __init, __trinary_op, __d_result)

//#!
//#! macro<_Tp, execution=parallel>(_Tp &* __first1, _Tp &* __last1, _Tp &* __first2, _Tp __init, __trinary_op, _Tp<return> & __d_result) : void
//#!
#	if MU0_HAVE_PARALLELIZE
#	define mu9_parallel_accumulate6(_Tp, __first1, __last1, __first2, __init, __trinary_op, __d_result) \
	mu9_parallel_accumulate05(_Tp, __first1, __last1, __first2, __init, __trinary_op, __d_result)
#	else
#	define mu9_parallel_accumulate6(_Tp, __first1, __last1, __first2, __trinary_op, __init, __d_result) \
	mu9_sequencial_accumulate6(_Tp, __first1, __last1, __first2, __init, __trinary_op, __d_result)
#	endif
