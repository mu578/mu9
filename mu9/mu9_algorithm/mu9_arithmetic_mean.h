...
#	define mu9_arithmetic_mean1(_Tp, _Real, __first, __last, __d_result1, __d_result2)              \
mu0_scope_begin                                                                                    \
	...
	__d_result2 = __mu9_arithmetic_mean1__s__ / mu0_const_cast(_Real, __mu9_arithmetic_mean1__n__); \
mu0_scope_end

#	define mu9_arithmetic_mean2(_Tp, _Real, __first, __last, __d_result)              \
mu0_scope_begin                                                                      \
	_Real            __mu9_arithmetic_mean2__m__ = mu0_const_cast(_Real, 0);          \
...
#	define mu9_arithmetic_mean3(_Tp, _Real, __first1, __last1, __first2, __d_result1, __d_result2, __d_result3, __d_result4) \
mu0_scope_begin                                                                                                             \
	...
	__d_result3 = __mu9_arithmetic_mean3__si__ / mu0_const_cast(_Real, __mu9_arithmetic_mean3__n__);                         \
	__d_result4 = __mu9_arithmetic_mean3__sj__ / mu0_const_cast(_Real, __mu9_arithmetic_mean3__n__);                         \
mu0_scope_end

#	define mu9_arithmetic_mean4(_Tp, _Real, __first1, __last1, __first2, __d_result1, __d_result2) \
mu0_scope_begin                                                                                   \
	_Real            __mu9_arithmetic_mean4__mi__ = mu0_const_cast(_Real, 0);                      \
	_Real            __mu9_arithmetic_mean4__mj__ = mu0_const_cast(_Real, 0);                      \
