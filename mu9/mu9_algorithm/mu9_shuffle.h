...
mu0_scope_begin                                                                                     \
	mu0_distance_t __mu9_shuffle1__i__ = mu9_distance(_Tp, __first, __last) - mu0_const_distance(1); \
	mu0_distance_t __mu9_shuffle1__j__;                                                              \
	for (; __mu9_shuffle1__i__ > 0; --__mu9_shuffle1__i__) {                                         \
		__mu9_shuffle1__j__ = mu0_const_distance(mu0_random_ranged_i64(0, __mu9_shuffle1__i__));      \
...
mu0_scope_begin                                                                                     \
	mu0_distance_t __mu9_shuffle2__i__ = mu9_distance(_Tp, __first, __last) - mu0_const_distance(1); \
	mu0_distance_t __mu9_shuffle2__j__;                                                              \
	for (; __mu9_shuffle2__i__ > 0; --__mu9_shuffle2__i__) {                                         \
		__mu9_shuffle2__j__ = mu0_const_distance(__urbg_fn(0, i));                                    \
...
mu0_scope_begin                                                                                     \
	mu0_distance_t __mu9_shuffle3__i__ = mu9_distance(_Tp, __first, __last) - mu0_const_distance(1); \
	mu0_distance_t __mu9_shuffle3__j__;                                                              \
	for (; __mu9_shuffle3__i__ > 0; --__mu9_shuffle3__i__) {                                         \
		__mu9_shuffle3__j__ = mu0_const_distance(mu0_random_ranged_i64(0, __mu9_shuffle1__i__));      \
...
mu0_scope_begin                                                                                     \
	mu0_distance_t __mu9_shuffle4__i__ = mu9_distance(_Tp, __first, __last) - mu0_const_distance(1); \
	mu0_distance_t __mu9_shuffle4__j__;                                                              \
	for (; __mu9_shuffle4__i__ > 0; --__mu9_shuffle4__i__) {                                         \
		__mu9_shuffle4__j__ = mu0_const_distance(__urbg_fn(0, i));                                    \
