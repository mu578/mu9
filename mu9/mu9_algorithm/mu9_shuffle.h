...
mu0_scope_begin                                                                          \
	mu0_distance_t __mu9_shuffle2__i__ = mu9_distance(__first, __last) - mu0_distance(1); \
	mu0_distance_t __mu9_shuffle2__j__;                                                   \
	for (; __mu9_shuffle2__i__ > 0; --__mu9_shuffle2__i__) {                              \
		__mu9_shuffle2__j__ = mu0_distance(__urbg_fn(i));                                  \
...
mu0_scope_begin                                                                           \
	mu0_distance_t __mu9_shuffle4__i__ = mu9_distance(__first, __last) - mu0_distance(1);  \
	mu0_distance_t __mu9_shuffle4__j__;                                                    \
	for (; __mu9_shuffle4__i__ > 0; --__mu9_shuffle4__i__) {                               \
		__mu9_shuffle4__j__ = mu0_distance(__urbg_fn(i));                                   \
