...
#	define mu9_inclusive_scan3(_Tp, __first, __last, __d_first, __init)         \
mu0_scope_begin                                                                \
	_Tp __mu9_inclusive_scan3__v__ = __init;                                    \
	for (; __first != __last; ++__first, (void) ++__d_first) {                  \
		__mu9_inclusive_scan3__v__ = _Tp, __mu9_inclusive_scan3__v__ + *__first; \
		*__d_first                 = __mu9_inclusive_scan3__v__;                 \
	}                                                                           \
mu0_scope_end

#	define mu9_inclusive_scan4(_Tp, __first, __last, __d_first, __init, __binary_op)        \
mu0_scope_begin                                                                            \
	_Tp __mu9_inclusive_scan4__v__ = __init;                                                \
	for (; __first != __last; ++__first, (void) ++__d_first) {                              \
		__mu9_inclusive_scan4__v__ = __binary_op(_Tp, __mu9_inclusive_scan4__v__, *__first); \
