...
mu0_scope_begin                                                                                                                         \
	...
	for (; __mu9_sort_heap1__l__ > mu0_const_distance(1); --__mu9_sort_heap1__k__, --__mu9_sort_heap1__l__) {                            \
		...
		mu9_heap_siftdown1(_Tp, __mu9_sort_heap1__j__, (__mu9_sort_heap1__l__ - mu0_const_distance(1)), __mu9_sort_heap1__i__, mu9_less); \
	}                                                                                                                                    \
mu0_scope_end
...
mu0_scope_begin                                                                                                                          \
	...
	for (; __mu9_sort_heap2__l__ > mu0_const_distance(1); --__mu9_sort_heap2__k__, --__mu9_sort_heap2__l__) {                             \
		...
		mu9_heap_siftdown1(_Tp, __mu9_sort_heap2__j__, (__mu9_sort_heap2__l__ - mu0_const_distance(1)), __mu9_sort_heap2__i__, __comp_fn); \
	}                                                                                                                                     \
mu0_scope_end
...
mu0_scope_begin                                                                                                                                     \
	...
	for (; __mu9_sort_heap3__l__ > mu0_const_distance(1); --__mu9_sort_heap3__k__, --__mu9_sort_heap3__l__) {                                        \
		...
		mu9_heap_siftdown2(_Tp, __mu9_sort_heap3__j__, (__mu9_sort_heap3__l__ - mu0_const_distance(1)), __mu9_sort_heap3__i__, __comp_fn, __move_op); \
	}                                                                                                                                                \
mu0_scope_end
