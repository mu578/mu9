...
#	define mu9_min_element3(_Tp, __first, __last, __comp_op, __d_result) \
mu0_scope_begin                                                         \
	...
	if (__first != __last) {                                             \
		...
		++__first;                                                        \
		for (; __first != __last; ++__first) {                            \
			if (__comp_op(_Tp, *__first,  *__mu9_min_element3_i__)) {      \
				__mu9_min_element3_i__ = __first;                           \
			}                                                              \
		}                                                                 \
	}                                                                    \
...
#	define mu9_min_element4(_Tp, __first, __last, __sort_op, __ctx, __d_result) \
mu0_scope_begin                                                                \
	_Tp * __mu9_min_element4_i__ = __last;                                      \
	if (__first != __last) {                                                    \
		__mu9_min_element4_i__ = __first;                                        \
		++__first;                                                               \
		for (; __first != __last; ++__first) {                                   \
			if (__sort_op(_Tp, *__first,  *__mu9_min_element4_i__, __ctx)) {      \
				__mu9_min_element4_i__ = __first;                                  \
			}                                                                     \
		}                                                                        \
	}                                                                           \
	__d_result = __mu9_min_element4_i__;                                        \
mu0_scope_end
