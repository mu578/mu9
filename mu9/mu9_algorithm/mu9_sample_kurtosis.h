...
#	define mu9_sample_kurtosis1(_Tp, _Real, __first, __last, __d_result1, __d_result2, __d_result3)                               \
mu0_scope_begin                                                                                                                  \
	_Real            __mu9_sample_kurtosis1__m2__ = mu0_const_cast(_Real, 0);                                                     \
	_Real            __mu9_sample_kurtosis1__m4__ = mu0_const_cast(_Real, 0);                                                     \
	_Real            __mu9_sample_kurtosis1__v__;                                                                                 \
	_Real            __mu9_sample_kurtosis1__m__;                                                                                 \
	_Real            __mu9_sample_kurtosis1__s__;                                                                                 \
	mu0_difference_t __mu9_sample_kurtosis1__n__  = mu0_difference(1);                                                            \
	mu9_arithmetic_mean1(_Tp, _Real, __first, __last, __mu9_sample_kurtosis1__s__, __mu9_sample_kurtosis1__m__);                  \
	...
	if (__mu9_sample_kurtosis1__n__ > mu0_difference(4)) {                                                                        \
		...
		__d_result1 = __mu9_sample_kurtosis1__s__;                                                                                 \
		__d_result2 = __mu9_sample_kurtosis1__m__;                                                                                 \
		__d_result3 = mu0_const_cast(_Real, 0);                                                                                    \
	}                                                                                                                             \
mu0_scope_end

#	define mu9_sample_kurtosis2(_Tp, _Real, __first, __last, __mean_value, __d_result)                                            \
mu0_scope_begin                                                                                                                  \
	_Real            __mu9_sample_kurtosis2__m2__ = mu0_const_cast(_Real, 0);                                                     \
	_Real            __mu9_sample_kurtosis2__m4__ = mu0_const_cast(_Real, 0);                                                     \
	_Real            __mu9_sample_kurtosis2__v__;                                                                                 \
	_Real            __mu9_sample_kurtosis2__m__  = mu0_const_cast(_Real, __mean_value);                                          \
	...
	if (__mu9_sample_kurtosis2__n__ > mu0_difference(4)) {                                                                        \
		...
		__d_result = mu0_const_cast(_Real, 0);                                                                                     \
	}                                                                                                                             \
mu0_scope_end
