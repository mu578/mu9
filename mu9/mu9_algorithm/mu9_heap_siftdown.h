...
mu0_scope_begin                                                                                              \
	...
	if (!(__len < 2 || (__len - 2) / 2 < __mu9_heap_siftdown1__c__)) {                                        \
		...
		__mu9_heap_siftdown1__i__ = mu9_next_n(__first, __mu9_heap_siftdown1__c__);                            \
		if ((__mu9_heap_siftdown1__c__ + 1) < __len && __comp_fn(_Tp                                           \
		...
		if (!__comp_fn(_Tp, *__mu9_heap_siftdown1__i__, *__start)) {                                           \
			...
			do {                                                                                                \
				*__start                  = *__mu9_heap_siftdown1__i__;                                          \
				__start                   =  __mu9_heap_siftdown1__i__;                                          \
				__mu9_heap_siftdown1__d__ = (__len - mu0_const_distance(2)) / mu0_const_distance(2);             \
				...
				__mu9_heap_siftdown1__i__ = __first + __mu9_heap_siftdown1__c__;                                 \
				if ((__mu9_heap_siftdown1__c__ + mu0_const_distance(1)) < __len && __comp_fn(_Tp                 \
					, *(__mu9_heap_siftdown1__i__)                                                                \
					, *(__mu9_heap_siftdown1__i__ + mu0_const_distance(1))                                        \
				)) { ++__mu9_heap_siftdown1__i__; ++__mu9_heap_siftdown1__c__; }                                 \
...
mu0_scope_begin                                                                                              \
	...
	if (!(__len < 2 || (__len - 2) / 2 < __mu9_heap_siftdown2__c__)) {                                        \
		...
		__mu9_heap_siftdown2__i__ = mu9_next_n(__first, __mu9_heap_siftdown2__c__);                            \
		if ((__mu9_heap_siftdown2__c__ + 1) < __len && __comp_fn(_Tp                                           \
		...
		if (!__comp_fn(_Tp, *__mu9_heap_siftdown2__i__, *__start)) {                                           \
			...
			do {                                                                                                \
				...
				__mu9_heap_siftdown2__d__ = (__len - mu0_const_distance(2)) / mu0_const_distance(2);             \
				...
				__mu9_heap_siftdown2__i__ = __first + __mu9_heap_siftdown2__c__;                                 \
				if ((__mu9_heap_siftdown2__c__ + mu0_const_distance(1)) < __len && __comp_fn(_Tp                 \
					, *(__mu9_heap_siftdown2__i__)                                                                \
					, *(__mu9_heap_siftdown2__i__ + mu0_const_distance(1))                                        \
				)) { ++__mu9_heap_siftdown2__i__; ++__mu9_heap_siftdown2__c__; }                                 \
