...
mu0_scope_begin                                                                              \
	...
	while (__first != __last) {                                                               \
		...
		for (; __mu9_for_each_by__j__ != __mu9_for_each_by__i__; ++__mu9_for_each_by__j__) {   \
			if (__first == __last) {                                                            \
...
mu0_scope_begin                                                                                \
	...
	mu0_distance_t __mu9_for_each_by_n__j__ = (mu0_const_distance(__by) < mu0_const_distance(1) \
	mu0_distance_t __mu9_for_each_by_n__k__;                                                    \
		? mu0_const_distance(1)                                                                  \
		: mu0_const_distance(__by)                                                               \
	);                                                                                          \
	for (; __mu9_for_each_by_n__i__ < mu0_const_distance(__n);) {                               \
		__unary_fn(Tp, *__first);                                                                \
		__mu9_for_each_by_n__k__ = mu0_const_distance(0);                                        \
		for (; __mu9_for_each_by_n__k__ != __mu9_for_each_by__j__; ++__mu9_for_each_by_n__k__) { \
