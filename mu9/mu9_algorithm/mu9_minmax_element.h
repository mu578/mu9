...
mu0_scope_begin                                                                                       \
	...
	if (!(__first == __last || ++__first == __last)) {                                                 \
		...
		while (++__first != __last) {                                                                   \
			...
			if (++__first == __last) {                                                                   \
				if (__comp_fn(_Tp, *__mu9_minmax_element2__k__, *__mu9_minmax_element2__i__)) {           \
					__mu9_minmax_element2__i__ = __mu9_minmax_element2__k__;                               \
				} else if (!(__comp_fn(_Tp, *__mu9_minmax_element2__k__, *__mu9_minmax_element2__j__))) { \
				...
				if (__comp_fn(*__first, *__mu9_minmax_element2__k__)) {                                   \
					...
					if (!(__comp_fn(_Tp, *__mu9_minmax_element2__k__, *__mu9_minmax_element2__j__))) {     \
						__mu9_minmax_element2__j__ = __mu9_minmax_element2__k__;                            \
					}                                                                                      \
				} else {                                                                                  \
					if (__comp_fn(_Tp, *__mu9_minmax_element2__k__, *__mu9_minmax_element2__i__)) {        \
					...
					if (!(__comp_fn(_Tp, *__first, *__mu9_minmax_element2__j__))) {                        \
						__mu9_minmax_element2__j__ = __first;                                               \
					}                                                                                      \
				}                                                                                         \
			}                                                                                            \
