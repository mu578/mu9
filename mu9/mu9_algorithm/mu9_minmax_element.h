...
#	define mu9_minmax_element3(_Tp, __first, __last, __comp_op, __d_result1, __d_result2)              \
mu0_scope_begin                                                                                       \
	_Tp * __mu9_minmax_element3__i__ = __first;                                                        \
	_Tp * __mu9_minmax_element3__j__ = __first;                                                        \
	_Tp * __mu9_minmax_element3__k__;                                                                  \
	if (!(__first == __last || ++__first == __last)) {                                                 \
		if (__comp_op(_Tp, *__first, *__mu9_minmax_element3__i__)) {                                    \
		...
		while (++__first != __last) {                                                                   \
			...
			if (++__first == __last) {                                                                   \
				if (__comp_op(_Tp, *__mu9_minmax_element3__k__, *__mu9_minmax_element3__i__)) {           \
					__mu9_minmax_element3__i__ = __mu9_minmax_element3__k__;                               \
				} else if (!(__comp_op(_Tp, *__mu9_minmax_element3__k__, *__mu9_minmax_element3__j__))) { \
				...
				if (__comp_op(_Tp, *__first, *__mu9_minmax_element3__k__)) {                              \
					...
					if (!(__comp_op(_Tp, *__mu9_minmax_element3__k__, *__mu9_minmax_element3__j__))) {     \
						__mu9_minmax_element3__j__ = __mu9_minmax_element3__k__;                            \
					}                                                                                      \
				} else {                                                                                  \
					if (__comp_op(_Tp, *__mu9_minmax_element3__k__, *__mu9_minmax_element3__i__)) {        \
					...
					if (!(__comp_op(_Tp, *__first, *__mu9_minmax_element3__j__))) {                        \
						__mu9_minmax_element3__j__ = __first;                                               \
					}                                                                                      \
				}                                                                                         \
			}                                                                                            \
