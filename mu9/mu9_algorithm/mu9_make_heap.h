...
mu0_scope_begin                                                                                                              \
	...
	if (__mu9_make_heap1__l__ > mu0_const_distance(1)) {                                                                      \
		for (; __mu9_make_heap1__i__ >= 0; --__mu9_make_heap1__i__) {                                                          \
			mu9_heap_siftdown1(_Tp, __first, __mu9_make_heap1__l__, mu9_next_n(_Tp, __first, __mu9_make_heap1__i__), mu9_less); \
		}                                                                                                                      \
	}                                                                                                                         \
mu0_scope_end
...
mu0_scope_begin                                                                                                               \
	...
	if (__mu9_make_heap2__l__ > mu0_const_distance(1)) {                                                                       \
		for (; __mu9_make_heap2__i__ >= 0; --__mu9_make_heap2__i__) {                                                           \
			mu9_heap_siftdown1(_Tp, __first, __mu9_make_heap2__l__, mu9_next_n(_Tp, __first, __mu9_make_heap2__i__), __comp_fn); \
		}                                                                                                                       \
	}                                                                                                                          \
mu0_scope_end
...
mu0_scope_begin                                                                                                                          \
	...
	if (__mu9_make_heap3__l__ > mu0_const_distance(1)) {                                                                                  \
		for (; __mu9_make_heap3__i__ >= 0; --__mu9_make_heap3__i__) {                                                                      \
			mu9_heap_siftdown2(_Tp, __first, __mu9_make_heap3__l__, mu9_next_n(_Tp, __first, __mu9_make_heap3__i__), __comp_fn, __move_op); \
		}                                                                                                                                  \
	}                                                                                                                                     \
mu0_scope_end
