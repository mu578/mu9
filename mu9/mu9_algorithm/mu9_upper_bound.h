...
mu0_scope_begin                                                                \
	...
	while (__mu9_upper_bound1__c__ > 0) {                                       \
		__mu9_upper_bound1__i__ = __first;                                       \
		__mu9_upper_bound1__n__ = __mu9_upper_bound1__c__ / 2;                   \
		...
		if (!(__value < *__mu9_upper_bound1__i__)) {                             \
				...
				__mu9_upper_bound1__c__ -= __mu9_upper_bound1__n__ + 1;            \
		} else {                                                                 \
...
mu0_scope_begin                                                                  \
	...
	while (__mu9_upper_bound2__c__ > 0) {                                         \
		__mu9_upper_bound2__i__ = __first;                                         \
		__mu9_upper_bound2__n__ = __mu9_upper_bound2__c__ / 2;                     \
		...
		if (!__comp_fn(__value, *__mu9_upper_bound2__i__)) {                       \
				...
				__mu9_upper_bound2__c__ -= __mu9_upper_bound2__n__ + 1;              \
		} else {                                                                   \
...
#	define mu9_upper_bound3(_Tp, __first, __last, __value, __comp_fn, __ctx, __d_result) \
mu0_scope_begin                                                                         \
	...
	while (__mu9_upper_bound3__c__ > 0) {                                                \
		__mu9_upper_bound3__i__ = __first;                                                \
		__mu9_upper_bound3__n__ = __mu9_upper_bound3__c__ / 2;                            \
		mu9_advance_n(_Tp, __mu9_upper_bound3__i__, __mu9_upper_bound3__n__);             \
		if (!__comp_fn(__value, *__mu9_upper_bound3__i__, __ctx)) {                       \
				__first                  = ++__mu9_upper_bound3__i__;                       \
				__mu9_upper_bound3__c__ -= __mu9_upper_bound3__n__ + 1;                     \
		} else {                                                                          \
