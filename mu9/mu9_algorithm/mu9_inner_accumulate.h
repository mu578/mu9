...
mu0_scope_begin                                                                                   \
	_Tp __mu9_inner_accumulate1__s__ = mu0_const_cast(_Tp, __init1);                               \
	_Tp __mu9_inner_accumulate1__q__ = mu0_const_cast(_Tp, __init2);                               \
...
mu0_scope_begin                                                                                                               \
	_Tp __mu9_inner_accumulate2__s__ = mu0_const_cast(_Tp, __init1);                                                           \
	_Tp __mu9_inner_accumulate2__q__ = mu0_const_cast(_Tp, __init2);                                                           \
	while (__first != __last) {                                                                                                \
...
mu0_scope_begin                                                                                                              \
	_Tp __mu9_inner_accumulate3__s__ = mu0_const_cast(_Tp, __init1);                                                          \
	_Tp __mu9_inner_accumulate3__q__ = mu0_const_cast(_Tp, __init2);                                                          \
	while (__first != __last) {                                                                                               \
...
mu0_scope_begin                                                                                                                     \
	_Tp __mu9_inner_accumulate4__s__ = mu0_const_cast(_Tp, __init1);                                                                 \
	_Tp __mu9_inner_accumulate4__w__ = mu0_const_cast(_Tp, __init2);                                                                 \
	_Tp __mu9_inner_accumulate4__q__ = mu0_const_cast(_Tp, __init3);                                                                 \
...
mu0_scope_begin                                                                                                                                                 \
	_Tp __mu9_inner_accumulate5__s__ = mu0_const_cast(_Tp, __init1);                                                                                             \
	_Tp __mu9_inner_accumulate5__w__ = mu0_const_cast(_Tp, __init2);                                                                                             \
	_Tp __mu9_inner_accumulate5__q__ = mu0_const_cast(_Tp, __init3);                                                                                             \
	while (__first1 != __last1) {                                                                                                                                \
