...
#	define mu9_binary_search3(_Tp, __first, __last, __value, __comp_fn, __ctx, __d_result)                    \
mu0_scope_begin                                                                                              \
	_Tp * __mu9_lower_bound2__d__;                                                                            \
	mu9_lower_bound3(__Tp, __first, __last, __value, __comp_fn, __ctx, __mu9_lower_bound2__d__);              \
	__d_result = ((__mu9_lower_bound2__d__ != __last && !__comp_fn(__value, *__mu9_lower_bound2__d__, __ctx)) \
		? mu0_true                                                                                             \
		: mu0_false                                                                                            \
	);                                                                                                        \
mu0_scope_end
