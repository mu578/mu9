...
mu0_scope_begin                                                                                                                \
	if (mu0_not_nullptr(__cursor) && mu0_not_nullptr(__node)) {                                                                 \
		__node_next(_Tp, __node)   = __node_next(_Tp, __cursor);                                                                 \
		__node_next(_Tp, __cursor) = __node;                                                                                     \
		__node_prev(_Tp, __node)   = __cursor;                                                                                   \
		__d_result                 = mu0_true;                                                                                   \
		if (mu0_not_nullptr(__node_next(_Tp, __node))) {                                                                         \
			__node_prev(_Tp, __node_next(_Tp, __node)) = __node;                                                                  \
		}                                                                                                                        \
	} else {                                                                                                                    \
