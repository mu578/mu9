...
//#!
//#! macro<_Tp, _Uint>(_Tp &* __seq, _Tp<operator> * __node_next, const _Uint & __i, _Tp &* __node, _Bool<return> & __d_result) : void
//#!
#	define mu9_sequence_insert_at(_Tp, __seq, __node_next, __i, __node, __d_result)                                    \
mu0_scope_begin                                                                                                       \
	...
	if (!mu0_is_nullptr(__seq) && __mu9_sequence_insert_at__k__ >= mu0_const_distance(0)) {                            \
		__d_result_                   = mu0_false;                                                                      \
		__mu9_sequence_insert_at__h__ = &(__seq);                                                                       \
		__mu9_sequence_insert_at__f__ = &(__seq);                                                                       \
		...
		if (!__mu9_sequence_insert_at__x__) {                                                                           \
			...
			__seq                                           = *__mu9_sequence_insert_at__h__;                            \
