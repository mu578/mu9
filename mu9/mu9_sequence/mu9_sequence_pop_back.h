...
mu0_scope_begin                                                                                                                \
	...
	if (mu0_not_nullptr(__head)) {                                                                                              \
		...
		if (mu0_not_nullptr(__node_next(Tp, *__mu9_sequence_pop_back__h__))) {                                                   \
			while (                                                                                                               \
				   mu0_not_nullptr(__node_next(Tp, *__mu9_sequence_pop_back__h__))                                                 \
				&& mu0_not_nullptr(__node_next(Tp, __node_next(Tp, *__mu9_sequence_pop_back__h__)), *__mu9_sequence_pop_back__h__) \
			) {                                                                                                                   \
