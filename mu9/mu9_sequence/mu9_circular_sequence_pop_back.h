...
//#!
#	define mu9_circular_sequence_pop_back(_Tp, __head, __tail, __node_next, __d_node)                                                               \
mu0_scope_begin                                                                                                                                    \
	_Tp ** __mu9_circular_sequence_pop_back__h__;                                                                                                   \
	if (mu0_not_nullptr(__head)) {                                                                                                                  \
		__mu9_circular_sequence_pop_back__h__ = &(__head);                                                                                           \
		if (mu0_not_nullptr(__node_next(_Tp, *__mu9_circular_sequence_pop_back__h__))) {                                                             \
			while (                                                                                                                                   \
				   mu0_not_nullptr(__node_next(_Tp, *__mu9_circular_sequence_pop_back__h__))                                                           \
				&& mu0_not_nullptr(__node_next(_Tp, __node_next(_Tp, *__mu9_circular_sequence_pop_back__h__)), *__mu9_circular_sequence_pop_back__h__) \
			) {                                                                                                                                       \
				*__mu9_circular_sequence_pop_back__h__ = __node_next(_Tp, *__mu9_circular_sequence_pop_back__h__);                                     \
			}                                                                                                                                         \
			__tail                                                   = *__mu9_circular_sequence_pop_back__h__;                                        \
			__d_node                                                 = __node_next(_Tp, *__mu9_circular_sequence_pop_back__h__);                      \
			__node_next(_Tp, *__mu9_circular_sequence_pop_back__h__) = mu0_nullptr;                                                                   \
